...
Contributions are welcome! Please fork, branch, and PR.

---

## 📜 License

_No license file provided. Please add one (MIT/Apache 2.0 recommended) if you want to open-source the project._

---

## 🙏 Acknowledgments

- Lehrstuhl für Mustererkennung (Informatik 5), FAU Erlangen-Nürnberg  
- Advisor: **Hakan Calim**  
- Prior work cited: Optical flow, SIFT/SURF, complementary filtering, IMU navigation literature.
